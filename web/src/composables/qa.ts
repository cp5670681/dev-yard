...
export const QA_GATE_ACTIONS = new Set(["qa-design", "qa-review", "qa-run"]);
...
/**
 * Whether a QA design/review/run job for `jira` is currently in flight.
 *
